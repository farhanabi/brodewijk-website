...
import Header from '../component/HeaderBookAppointment';
      ...
      <div className={classes.howItWorks} id='howItWorks'>
        ...
        <div className={classes.howItWorksGrid}>
          ...
          <div style={{color:'rgba(100,100,100)'}} className={classes.howItWork} >
            ...
            <p className={classes.howItWorkPar}>Measured directly by our proffesional tailorman, giving you the best fit suit you’ve ever made</p>
          </div>
          <div style={{color:'rgba(100,100,100)'}} className={classes.howItWork} >
          ...
          <div style={{color:'rgba(100,100,100)'}} className={classes.howItWork} >
            ...
            <p className={classes.howItWorkPar}>The suit making can take up to 14 days then we ship it to you right away!</p>
          </div>
        </div>
      </div>
      <a href='https://calendly.com/brodewijk-bookappointment/pengukuran-jas?month=2019-12' target='_blank' style={{textDecoration:'none', color:'rgba(50,50,50,1)',margin:0,width:'100%'}}><span className={classes.bookNow}>BOOK APPOINTMENT NOW</span></a>
